...
\href{https://help.ubuntu.com/10.04/serverguide/apt-get.html}{
Advanced Packaging Tool}, which we invoke with \bash{apt-get}.  We'll install a 
...
Open your interpreter, type \bash{python} and then \py{print("Hello, World!")}.
...
addition in multiplication (and it works in a sane fashion).  The \code{\\n}
